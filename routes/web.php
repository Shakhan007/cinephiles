...
Route::get('/addcolor', [profileController::class,'addcolor']);
Route::post('/sharethismeme', [profileController::class,'sharethismeme']);
Route::post('/removememe', [profileController::class,'removememe']);
